...
public class MySwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3,
   ...
   private void setColorViewAlpha(int targetAlpha) {
      Drawable background = mCircleView.getBackground();
      if (background != null) {
   ...
   public MySwipeRefreshLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
      ...
      rotateAnimator = ObjectAnimator.ofFloat(mCircleView, View.ROTATION, 360f);
   ...
   private void animateOffsetToCorrectPosition(int from, AnimationListener listener) {
      ...
      mAnimateToCorrectPosition.setAnimationListener(new AnimationListener() {
         @Override
         public void onAnimationStart(Animation animation) {
            mCircleView.onStartAnimatingToIdlePosition();
         }

         @Override
         public void onAnimationEnd(Animation animation) {
            mCircleView.onEndAnimatingToIdlePosition();
         }
      ...
      rotateAnimator.cancel();
      rotateAnimator.setFloatValues(mCircleView.getRotation(), 360f);
